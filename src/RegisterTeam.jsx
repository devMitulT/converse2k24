...
const RegisterTeam = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const isContactNumber2Valid =
      !isSecondSetVisible || validateContactNumber(formData.contactNumber2);
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='form-group'>
            ...
            <p className='Email-text'>
              If you have <a>SCET ID</a> , register with it, otherwise use
              Gmail.
            </p>
          </div>
          ...
          {isSecondSetVisible && (
            <>
              ...
              <div className='form-group'>
                <label htmlFor='enrollment2'>
                  Enrollment No (Participant 2):
                </label>
                <input
                  type='text'
                  id='enrollment2'
